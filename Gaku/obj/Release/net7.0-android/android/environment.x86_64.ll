...
@__app_environment_variables_v_1.3 = internal constant [37 x i8] c"ced8cd29-107b-4609-b3f7-9bd4e2574aa9\00", align 16
...
@__ApplicationConfig_android_package_name.0 = internal constant [21 x i8] c"com.companyname.gaku\00", align 16
...
@__DSOCacheEntry_name.24 = internal constant [19 x i8] c"libaot-Gaku.dll.so\00", align 16
...
@dso_cache = local_unnamed_addr global [470 x %struct.DSOCacheEntry] [
	...
	; 24
	%struct.DSOCacheEntry {
		i64 1009242778872112512, ; hash 0xe018cf5cecce580, from name: Gaku
		i8 0, ; ignore
	...
	; 238
	%struct.DSOCacheEntry {
		i64 9807327164962690558, ; hash 0x881aa01857a3d5fe, from name: libaot-Gaku
		i8 0, ; ignore
		i8* getelementptr inbounds ([19 x i8], [19 x i8]* @__DSOCacheEntry_name.24, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 259
	%struct.DSOCacheEntry {
		i64 10707169585995924310, ; hash 0x949782026b274356, from name: aot-Gaku.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([19 x i8], [19 x i8]* @__DSOCacheEntry_name.24, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 375
	%struct.DSOCacheEntry {
		i64 14729821048724530800, ; hash 0xcc6ad633ae4c2670, from name: Gaku.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([19 x i8], [19 x i8]* @__DSOCacheEntry_name.24, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 402
	%struct.DSOCacheEntry {
		i64 15823696606168289689, ; hash 0xdb991039cc371199, from name: libaot-Gaku.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([19 x i8], [19 x i8]* @__DSOCacheEntry_name.24, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 425
	%struct.DSOCacheEntry {
		i64 16727334703260174889, ; hash 0xe8236e4992e30a29, from name: aot-Gaku
		i8 0, ; ignore
		i8* getelementptr inbounds ([19 x i8], [19 x i8]* @__DSOCacheEntry_name.24, i32 0, i32 0), ; name
		i8* null; handle
	}, 
